...
2. The Semantic OS graph engine identifies `schema.user` and traverses its edges. It finds an `enforces` edge connecting it to `infrastructure.database.rules`.
